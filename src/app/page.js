...
export default function Home() {
  return (
    <main>
      ...
      <section>
        <div>
          <Service img={days}  alt={"Time"}  head="Open 6 Days A Weak" disc="providing you with flexible access to our facilities and classes. Whether you're an early riser or prefer evening workouts, we're here to help you stay consistent and achieve your fitness goals!" />
        </div>
        <div>
          <Service img={clin}  alt={"Cline"} head=" Clean and Hygienic Space" disc="Our gym prioritizes cleanliness and hygiene, ensuring a spotless and safe environment for all members. We follow strict sanitization protocols and maintain high standards to keep you healthy while you focus on your fitness goals." />
        </div>
        <div>
          <Service img={qulity} alt={"qulity"}  head="Qulity and Letest Equiptment" disc="Our gym is equipped with the latest, high-quality machines and tools to enhance your workout experience. From cardio to strength training, we provide top-tier equipment designed to help you achieve your fitness goals efficiently and safely" />
        </div>
      </section>
      <section>
