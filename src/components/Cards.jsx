    ...
    return (
        <>
            ...
            <div className=" overflow-hidden hover:scale-105 hover:z-10 rounded-md duration-500 border relative w-[90%] h-[250px] md:w-[40%] md:h-[45%]">
                ...
                <button onClick={handlePayment} className="absolute right-4 bottom-2 z-30 border-black bg-white rounded-md px-3 py-2 font-bold transition-all duration-500 transform hover:bg-black hover:text-white hover:border-0 hover:scale-110 shadow-md">
                    Enroll Now
                </button>
